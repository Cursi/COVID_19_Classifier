...
simptome_raportate = ["febr1", "asim1", "tuse1", "disp1", "mialg1", "fris1", "cefal1", "odin1",
					  "aste1n", "fatiga1", "sub1", "cianoz1", "inapetent1", "great1", "grava1", "anosmi1", "tegumente1",
					  "abdo1",
					  "torac1", "muscula1", "hta1"]

diagnostic = ["bronho2", "susp2", "tuse2", "odino2", "fris2", "cefal2", "febr2", "hta2", "mialg2", "disp2",
			  "gang2", "insuf2", "infec2", "pneumonie2",
			  "respiratorie2"]  # la insuficienta si respiratorie or sa puna doi de 1 desi e acelasi item

simptome_declarate = ["febra3", "tuse3", "dispn3", "asim3", "mialg3", "asten3", "cefalee3", "inapetent3",
					  "subfe3", "fris3", "disfag3", "fatig3", "greuturi3", "greata3", "muscu3",
					  "toracic3"]  # avem si greturi si greata aia e
...
X = np.asarray(df_upsampled[
				   featuresDF])  # Pe astea vreau sa le folosesc sa fac predictia clasei (cancerigen sau nu) - variabile INDEPENDENTE
Y = np.asarray(
	df_upsampled['rezultat testare'])  # Aci am rezultatul real cu care voi putea sa compar - variabile DEPENDENTE
...
#classifier = AdaBoostClassifier(RandomForestClassifier(random_state=4, n_estimators=10, criterion="entropy"),
								#random_state=4)
